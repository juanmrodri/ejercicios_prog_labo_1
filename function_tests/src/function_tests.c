...
int main(void) {
	...
	// pedir float
	if(utn_getFloatNum(&flotanteIngresado, "Por favor ingrese un numero flotante ", "error al ingresar el flotante\n\n", 0, 100, 2)==0)
	{
	...
	// pedir int
	if(utn_getIntNum(&enteroIngresado, "Por favor ingrese un numero entero ", "error al ingresar el entero\n\n", 1, 100, 2)==0)
	{
