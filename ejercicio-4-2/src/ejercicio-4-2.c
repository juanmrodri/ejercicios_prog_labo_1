 ...
 while(response!=5)
 {
	 ...
	 case 3:
		 ...
		 else
		 {
			 if(tempCelsiusIngresada!=0)
			 {
				 tempTrasformada=transformarCelsiusAfaren(tempCelsiusIngresada);
				 printf("%d en Celsius son: %.2f en Fahrenheit\n", tempCelsiusIngresada, tempTrasformada);
			 }
		 }
		 break;
	 case 4:
		 ...
		 else
		 {
			 if(tempFahrenheit!=0)
			 {
				 tempTrasformada=transformarFarenAcelsius(tempFahrenheit);
				 printf("%d en Fahrenheit son: %.2f en Celsius\n", tempFahrenheit, tempTrasformada);
			 }
		 }
		 break;
	 }
